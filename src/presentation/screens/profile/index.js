...
//   const clampedScrollY = Animated.diffClamp(scrollY, 0, 150);

//   const headerTranslateY = clampedScrollY.interpolate({
//     inputRange: [0, 150],
//     outputRange: [0, -heightToDp(19)],
//     extrapolate: "clamp",
//   });
...
//   const contentOpacity = clampedScrollY.interpolate({
//     inputRange: [0, 120],
//     outputRange: [1, 0],
//     extrapolate: "clamp",
//   });
...
//                         {Return ? "+" : "-"} ₹
//                         {Math.abs(
//                           (portfolioData?.investment?.currentInvestedAmount || 0) -
//                             (portfolioData?.investment?.totalInvestedAmount || 0)
//                         )?.toFixed(2) || "0.00"}
//                       </Text>
//                     </View>
...
//   container: { flex: 1, backgroundColor: Config.Colors.white, position: "relative" },
//   safeArea: { flex: 1,position: "relative" },
//   androidStatusBar: { height: StatusBar.currentHeight, backgroundColor: "#f0b538" },
//   animatedHeader: { position: "absolute", width: "100%", zIndex: 10, overflow: "hidden" },
...
//   },
//   iconButton: { width: widthToDp(10), height: widthToDp(10), justifyContent: "center", alignItems: "center" },
//   greetingText: {
//     color: Config.Colors.white,
